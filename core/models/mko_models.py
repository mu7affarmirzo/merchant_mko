...
@receiver(post_save, sender=Merchants)
def create_password_for_merchant(sender, instance, created, **kwargs):
    if created:
        print("Helloo")


@receiver(pre_delete, sender=Merchants)
def create_password_for_merchant(sender, instance, **kwargs):
    print("Bye-Bye")
